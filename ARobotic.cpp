...
void ARobotic::sendCommand(byte command){
...
void ARobotic::sendData(byte data){
...
void ARobotic::printChar(char C, byte X, byte Y){
...
void ARobotic::printString(const char *String, byte X, byte Y, byte numChar){
...
void ARobotic::setCursorXY(byte X, byte Y){
